...
export const ActorStarredInComponent = (props: Props) => {
    ...
    return (
        <div className={'starredIn'}>
            {foundData.castMovies ?
                <form className={'register actor'}><label>search by title <input onChange={handleFilterData}
                                                                                 type="text"/></label></form> : null}
